#!/bin/bash
# Run JS scripting tests against mini-redis (EVAL executes JS).
# Usage: MINI_REDIS_HOST=127.0.0.1 MINI_REDIS_PORT=6379 ./tests/scripting_js/run_js_scripting_tests.sh
...
echo "Running mini-redis JS scripting tests"
